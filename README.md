<!-- mcp-name: io.github.CSOAI-ORG/workout-planner-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/workout-planner-ai-mcp.html)
...
[![PyPI](https://img.shields.io/pypi/v/workout-planner-ai-mcp)](https://pypi.org/project/workout-planner-ai-mcp/) [![Python](https://img.shields.io/pypi/pyversions/workout-planner-ai-mcp)](https://pypi.org/project/workout-planner-ai-mcp/)
...
```json
{
  "mcpServers": {
    "workout-planner-ai-mcp": {
      "command": "uvx",
      "args": ["workout-planner-ai-mcp"]
    }
  }
}
```

Or: `pip install workout-planner-ai-mcp` then run the `workout-planner-ai-mcp` command (stdio transport).

## Examples

Once configured, ask your assistant, for example:
- "Use `create_workout` to …"
- "Use `track_progress` to …"
- "Use `suggest_exercises` to …"
